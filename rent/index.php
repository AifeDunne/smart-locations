<html>
    <head>
        <title>Smart Locations - Rent Location</title>
	...
	<div id="page2">
		...
		<button id="searchButton">Search Rentals</button>
		</div>
	<script>
	function page2() {
			...
			data: { dataRequest: "RentHome", hasPrimary: hasData1, searchBy: searchType, searchWith: searchCrit, bedrooms: nData[0], bathrooms: nData[1], minimumP: nData[2], maximumP: nData[3], dateReady: nData[4], hasOptional: hasData2, cooling: oData[1], heating: oData[2], fireplace: oData[3], parking: oData[3], yearBuilt: oData[4] },
